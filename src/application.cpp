...
application::~application() { delete _singleton; }
...
void application::_touchpad_read(lv_indev_drv_t *indev_driver,
...
void application::_disp_flush(lv_disp_drv_t *disp, const lv_area_t *area,
                              lv_color_t *color_p) {
